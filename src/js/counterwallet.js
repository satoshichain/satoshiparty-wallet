...
$(document).ready(function() {
  ...
  $.reject({  
    ...
    header: 'Your browser is not supported with Shellparty Wallet',
    paragraph1: "Shellparty Wallet's security features require a newer browser than what you are using. We recommend Chrome for the best user experience."
